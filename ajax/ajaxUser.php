<?php
// Memanggil file berisi fungsi yang sering dipakai
require "../fungsi.php";
require "../head.html";
...
$sql = "SELECT * FROM user WHERE iduser LIKE '%$keyword%' OR username LIKE '%$keyword%' OR status LIKE '%$keyword%'";
...
$sql = "SELECT * FROM user WHERE iduser LIKE '%$keyword%' OR username LIKE '%$keyword%' OR status LIKE '%$keyword%' LIMIT $awalData, $jmlDataPerHal";
